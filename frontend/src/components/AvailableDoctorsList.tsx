    ...
    <div className="py-2">
        <div className="grid md:grid-cols-[1fr_2fr] items-center border-1 border-gray-400 p-6 rounded-md">
            ...
            <div className="flex flex-col items-center w-full">
                <div className="relative border-4  overflow-hidden object-cover h-36 mt-10 w-36" style={{borderRadius:"50%",borderColor:"#034154"}}>
                    <img src={url} alt="" />
                </div>
                ...
                <div className="flex flex-col mt-24 w-full gap-2">
