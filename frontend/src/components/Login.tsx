...
const Login = () => {
  ...
  return (
    <div className='flex flex-col border-2 border-gray-400 shadow-xl rounded z-10 my-4 bg-slate-100' style={{width:"rem",height:"rem"}}>
        ...
        <form className='flex flex-col items-start mt-2' onSubmit={onSubmit}>
            ...
            <input type='email' placeholder='Full Name/Email Id' className='outline-none border-1  border-gray-300 py-2 px-2 mb-6 ml-10 md:w-96' {...register("email",{
            ...
            <input type='password' placeholder='Password' className='outline-none border-1 border-gray-300 py-2 px-2 ml-10 mb-3 md:w-96' {...register("password",{
            ...
            <div className='flex flex-col items-start justify-between md:flex-row pt-6'>
