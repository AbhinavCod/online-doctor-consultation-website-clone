...
const VideoCallPage = () => {
        ...
        <>
            <div className='flex flex-col'>
                ...
                <div className="md:hidden flex flex-col items-center mt-4 p-6" style={{ backgroundColor: "#f8e9e6" }}>
                    ...
                    <p className='text-2xl text-gray-700 tracking-tight py-2'>Private consultation + Audio call · Starts at just ₹199</p>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <span className='my-auto text-xl'>+163 Doctors are online 🟢</span>
                    </div>
    ...
    <div className='flex flex-col md:flex-row md:justify-between bg-gray-800 rounded-md my-10 md:my-20 py-6 px-4 md:px-8'>
...
<div className='flex flex-col md:flex-col gap-10 items-start my-16'>
    <div className='text-4xl text-gray-800 font-semibold'>
        Benefits of Online Consultation
    </div>

    <div className='w-full md:w-auto border border-gray-500 shadow-md rounded-md z-10 flex flex-wrap my-12'>
        <div className='flex flex-col gap-4 flex-wrap items-start p-4 md:w-1/3'>
            <h1 className='text-2xl text-gray-700 font-semibold'>✔️Consult Top Doctors 24*7</h1>
            <p className='text-xl text-gray-600'>Connect instantly with a 24x7 specialist or choose to video visit a particular doctor.</p>
        </div>
